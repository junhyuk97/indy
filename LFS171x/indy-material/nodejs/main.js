...
const domainDid = "QCZWLa5WntwbqGXnuoLDeX"
const xApiKey = "HZKr2TH3Vu88fAfS8jYZ7oUMhgDgpm6UwjA33371R8HX:491JHWREyrorph9yqwsEEv9KRXZr6M6j6dD4D5uvc7u86fXAeVsMQArPrKyr71Hh9UY9feSSbv5UVUATRQ2eS1Zm"
const credDefId = "7MXRWDen2pkBnaMnznEuS4:3:CL:120754:lates"
...
async function run() {
	...
	await QR.toFile('ui/views/public/qrcode.jpg', inviteUrl)

	//-------------------------------------------------------------------
	// STEP 7 - Wait for anpublic process all connection and credential requests
	//-------------------------------------------------------------------
	while (true) {
...
app.use(express.static('ui/views/public'));
