<?php      
    ...
    $password = $_POST['pass'];  
        ...
        if($count == 1){  
            ...
            else if($username == 'thrift')
                echo "<script>location.href='http://127.0.0.1:3004'</script>";
            else if($username == 'amigojun')
                echo "<script>location.href='http://127.0.0.1:3005'</script>";
            else
