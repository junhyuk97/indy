...
COPY app.js main02.js package.json package-lock.json ./

COPY node_modules ./node_modules

COPY ui ./ui

EXPOSE 3000 5050 6060

COPY docker_entrypoint02.sh /docker_scripts/

# Start Ngrok tunnel for webhook URL in docker entrypoint
ENTRYPOINT ["/docker_scripts/docker_entrypoint02.sh"]
